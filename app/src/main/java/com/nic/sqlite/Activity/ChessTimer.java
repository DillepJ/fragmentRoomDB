...
public class ChessTimer extends AppCompatActivity implements View.OnClickListener,PopupMenu.OnMenuItemClickListener {
    ...
    ImageView timer1_img,timer2_img,resume_pause_icon;
    RelativeLayout timer1_img_rl,timer2_img_rl,timer3_img_rl,resume_pause_layout;
    ...
    private void intializeUI() {
        ...
        resume_pause_icon=findViewById(R.id.resume_pause_icon);
        resume_pause_layout=findViewById(R.id.resume_pause_layout);
        ...
        resume_pause_layout.setVisibility(View.GONE);
        ...
        resume_pause_icon.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.time_img2_rl:
                if(pause_status){
                    resume_pause_layout.setVisibility(View.VISIBLE);
